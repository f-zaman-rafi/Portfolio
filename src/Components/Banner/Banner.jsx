    ...
    return (
        <div className="flex flex-col-reverse gap-10 md:gap-0 md:flex-row justify-between items-center md:items-start relative ">
            <div className="flex-1 md:absolute pt-0 z-10">
                ...
                <Link to="Contact" smooth={true} duration={1500} hashSpy={true} spy={true}><p className="pt-7 md:pt-9 lg:pt-16 text-base text-center md:text-start text-gray-300 "><button className="border-b-[4px] border-[#4EE1A0] hover:text-[#4EE1A0] hover:font-bold hover:text-xl" style={{ transition: '1000ms' }}>Let's Connect</button></p></Link>
            </div>
